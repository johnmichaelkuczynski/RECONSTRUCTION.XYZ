...
import { Loader2, Play, Square, CheckCircle, AlertCircle, Clock, FileText } from 'lucide-react';
        ...
        {phase !== 'idle' && (
          <>
            ...
            <div className="border-t pt-4">
              ...
              <ScrollArea className="h-[400px] border rounded p-2 bg-gray-50 dark:bg-gray-900">
                {chunks.length === 0 ? (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-xs text-gray-400">
                            (target: {chunk.targetWords}, range: {chunk.minWords}-{chunk.maxWords})
                          </span>
                        </div>
